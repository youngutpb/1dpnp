...
#dt_min = 2.0*np.trunc(0.5*(dx**2)/(2*max(Dpos,Dneg))) # makes dt_min an even number
...
cmd0 = "rm cn.mp4"
os.system(cmd0)
cmd1 = "ffmpeg -framerate 2 -i cn_plate_%04d.png cn.mp4"
os.system(cmd1)
cmd2 = "rm *.png"
os.system(cmd2)
...
cmd3 = "rm phi.mp4"
os.system(cmd3)
cmd4 = "ffmpeg -framerate 2 -i phi_plate_%04d.png phi.mp4"
os.system(cmd4)
cmd5 = "rm phi_*.png"
os.system(cmd5)
