...
frame_dt = 5 # number of frames/sec for animations
...
for it in range(1, Nt+1) :
    ...
    for ix in np.arange(1, Nx) :
        ...
        if (ix == 1):
            ...
            #cn_anion[it,ix] = cn_anion[it-1,ix] + Lo_anion*cn_anion[it-1,ix]*rho_epo[ix]/dx**2*dt
            #cn_cation[it,ix] = cn_cation[it-1,ix] + Lo_cation*cn_cation[it-1,ix]*rho_epo[ix]/dx**2*dt
            
            cn_cation[it,0] = cn_cation[it,1]
            cn_anion[it,0] = cn_anion[it,1]
            #print("left")
        elif (ix == Nx-1) :
            cn_anion[it,ix] = cn_anion[it-1,ix] - (Danion*(cn_anion[it-1,ix]-cn_anion[it-1,ix-1])/dx**2)*dt + Lo_anion*cn_anion[it-1,ix]*rho_epo[ix]/dx**2*dt
            
            cn_anion[it,Nx] = cn_anion[it,Nx-1]
            cn_cation[it,ix] = cn_cation[it-1,ix] - (Dcation*(cn_cation[it-1,ix]-cn_cation[it-1,ix-1])/dx**2)*dt + Lo_cation*cn_cation[it-1,ix]*rho_epo[ix]/dx**2*dt
